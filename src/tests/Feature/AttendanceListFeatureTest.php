...
class AttendanceListFeatureTest extends TestCase
{
    ...
    {
        // 基準日：2025-01-15
        Carbon::setTestNow('2025-01-15 10:00');

        $me     = User::factory()->create();
        $other  = User::factory()->create();

        // 自分の今月の勤怠（2件）
        $a1 = $this->makeAttendance($me,  '2025-01-02', '09:00', '18:00:00');
        $a2 = $this->makeAttendance($me,  '2025-01-10', '10:00', '19:00:00');
        // 別ユーザーの勤怠（混入しないことを確認）
        $this->makeAttendance($other, '2025-01-03', '08:00', '17:00');
    ...
    public function 前月ボタン相当_前月の情報が表示される()
    {
        ...
        $this->makeAttendance($me, '2024-12-05', '09:30', '17:30');
        // 今月データ（混入チェック用）
        $this->makeAttendance($me, '2025-01-02', '09:00', '18:00');
        /** @var User $me */
    ...
    public function 翌月ボタン相当_翌月の情報が表示される()
    {
        ...
        $me = User::factory()->create();
        // 翌月(2025-02)にユニークな時刻
        $this->makeAttendance($me, '2025-02-05', '12:34', '20:45');
        // 今月データ（混入チェック用）
        $this->makeAttendance($me, '2025-01-02', '09:00', '18:00');
        /** @var User $me */
    ...
    public function 詳細リンクでその日の勤怠詳細に遷移する()
    {
        ...
        $attendance = $this->makeAttendance($me, '2025-01-10', '10:00', '19:00');
        /** @var User $me */
